...
Should::executeTests(function() {
    ...
    // $closureFunc = Func::new($closure, TypeHintFactory::tryParse("int|float"), Type::string(), Type::bool());
    // print_r($closureFunc);
    ...
    // Should::throw(InvalidArgumentException::class, fn() => Func::new(fn($a, $b, $c): bool => true, TypeHintFactory::undefined(), TypeHintFactory::undefined(), TypeHintFactory::undefined(), Type::void()));
    // Should::throw(InvalidArgumentException::class, fn() => Func::new(function($a, $b, $c): void {}, TypeHintFactory::undefined(), TypeHintFactory::undefined(), TypeHintFactory::undefined(), Type::void()));
});